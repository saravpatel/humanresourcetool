...
{
    [CustomAuthorize]
    public class MeEmployeePlannerController : Controller
    {
        #region Constant
        ...
        public ActionResult ListOfMonth(int year, int EmployeeId, int HolidayCountryId)
        {
            ...
            // var publicHolidayList = _employeePlannerMethod.getGetAllPublicHolidayByEmployee_JobCountry(EmployeeId);
            //var publicHolidayListByCountry = _employeePlannerMethod.getPublicHolidayByCountryList(HolidayCountryId);
            ...
            for (int i = 1; i <= TotalMonths; i++)
            {
                ...
                for (int j = 1; j <= totalDays; j++)
                {
                    ...
                    var travelLeaveTaken = travelLeave.Where(x => date.Date >= x.StartDate.Value.Date && date.Date <= (x.EndDate != null ? x.EndDate.Value.Date : x.StartDate.Value.Date)).FirstOrDefault();
                    ...
                    var annualLeaveTaken = annualLeave.Where(x => date.Date >= x.StartDate.Value.Date && date.Date <=(x.EndDate!= null ? x.EndDate.Value.Date : x.StartDate.Value.Date)).FirstOrDefault();
                    ...
                    var otherLeaveTaken = otherLeave.Where(x => date.Date >= x.StartDate.Value.Date && date.Date <= (x.EndDate != null ? x.EndDate.Value.Date:x.StartDate.Value.Date)).FirstOrDefault();
                    ...
                    var MaternityLeaveTaken = maternityPaternityList.Where(x => date.Date >= x.ActualStartDate.Value.Date & date.Date <= (x.ActualEndDate != null ? x.ActualEndDate.Value.Date : x.ActualStartDate.Value.Date)).FirstOrDefault();
            ...
            return PartialView("_MepartialListOfMonthYearWise", yearModel);
        }
        public List<EmployeePlannerDayViewModel> returnDayListTable(int MonthId, int YearId, int EmployeeId,int HolidayCountryID)
        {
            ...
            for (int j = 1; j <= totalDays; j++)
            {
                ...
                var maternitypaternityTaken = maternityPaternityList.Where(x => date.Date >= x.ActualStartDate.Value.Date && date.Date <= (x.ActualEndDate != null ? x.ActualEndDate.Value.Date : x.ActualStartDate.Value.Date)).FirstOrDefault();
        ...
        public ActionResult AnnualSettings(int Id)
        {
            ...
            return PartialView("_MePartialAllowanceSettingsView", model);
        }
        ...
        public ActionResult AddEditTOIL(int Id)
        {
            ...
            return PartialView("_MePartialAddEditTOILView", model);
        }
        ...
        #region Year wise Month and Date
        ...
        public ActionResult workPatten(int Id)
        {
            ...
            if (Id > 0)
            {
                ...
                return PartialView("_MepartialReadOnlyWorkPattern", model);
            }
            else
            {
                model.IsRotating = false;
                model.Id = 0;
                return PartialView("_MepartialNewWorkPattern", model);
            }
        ...
        public ActionResult TrueIsRotating(int workPatternId)
        {
            ...
            return PartialView("_MepartialTrueIsRotating", model);
        }
        ...
        {
            WorkPatternViewModel model = new WorkPatternViewModel();
            return PartialView("_MepartialFalseIsRotating", model);
        }
        ...
        public ActionResult SaveEmployeeWorkPattern(EmployeeWorkPatternViewModel model)
        {
            ...
            if (employeeList != null)
            {
                if (employeeList.EffectiveFrom.Date < effDate.Date)
                {
                    ...
                    return PartialView("_MepartialListOfDayMonthYearWise", returnModel);
                }
                else
                {
                    return Json("error", JsonRequestBehavior.AllowGet);
        ...
        public ActionResult WorkPatternHistory(int EmployeeId)
        {
            ...
            return PartialView("_MepartialHistoryWorkPatternView", Model);
        }
        ...
        public ActionResult AddEdit_AnnualLeave(int Id, int Date, int Month, int Year)
        {
            ...
            return PartialView("_MepartialAdd_AnnualLeave", model);
        }
        ...
        public ActionResult AddEdit_LateLeave(int Id, int Date, int Month, int Year)
        {
            ...
            if (Id > 0)
            {
                ...
                model.InTimeHr = data.LateHr;
                model.InTimeMin = data.LateMin;
            ...
            return PartialView("_MepartialAdd_LateLeave", model);
        }
        ...
        public ActionResult AddEdit_OtherLeave(int Id, int Date, int Month, int Year)
        {
            ...
            return PartialView("_MepartialAdd_OtherLeave", model);
        }
        ...
        public ActionResult AddEdit_Travel(int Id, int Date, int Month, int Year)
        {
            ...
            if (Id > 0)
            {
                ...
                if (model.IsLessThenADay == true)
                {
                    ...
                    model.EndTimeMin = (int)data.EndTimeHour;
            ...
            return PartialView("_MepartialAdd_TravelLeave", model);
        }
        ...
        public ActionResult AddEdit_TimeSheet(int Id, int Date, int Month, int Year)
        {
            ...
            if (Id > 0)
            {
                ...
                foreach (var timeSheet in timeSheetDetail)
                {
                    ...
                    if(detailModel.Customer!=null && detailModel.Customer!="")
                    {
                        int CustoId = Convert.ToInt32(detailModel.Customer);
                        var aspNetData = _db.AspNetUsers.Where(x => x.Id == CustoId && x.Archived == false).FirstOrDefault();
                        detailModel.Customer = aspNetData.FirstName + " " + aspNetData.LastName + " - " + aspNetData.SSOID;
                        detailModel.CustomerId = detailModel.CustomerId;
                    }
            ...
            return PartialView("_MepartialAdd_TimeSheet", model);
        }
        ...
        public ActionResult AddEdit_TimeSheet_Detail()
        {
            ...
            return PartialView("_MepartialAdd_TimeSheet_Detail", model);
        }
        ...
        public ActionResult BindPublicHolidayTemplate(int CountryId)
        {
            ...
            return PartialView("_Mepartial_Effactive_PublicHoliday", model);
        }
        ...
        public ActionResult GetHolidayDetail(int Id, int Date, int Month, int Year)
        {
            ...
            return PartialView("_MepartialAdd_PublicHoliday", holidayModel);
        }
        ...
        public ActionResult AddEdit_SickLeave(int Id, int Date, int Month, int Year)
        {
            ...
            return PartialView("_MePartialAdd_SickLeavesView", model);
        }
        ...
        public ActionResult AddEdit_MPLeaves(int Id, int Date, int Month, int Year, int EmployeeID)
        {
            ...
            return PartialView("_MepartialAddMaternityPaternityLeavesView", model);
        }
