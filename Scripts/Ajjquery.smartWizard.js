...
function SmartWizard(target, options) {
    ...
    this.buttons = {
        next: $('<a>' + options.labelNext + '</a>').attr("href", "#").addClass("btn btn-warning buttonNext"),
        previous: $('<a>' + options.labelPrevious + '</a>').attr("href", "#").addClass("btn btn-warning buttonPrevious"),
        finish: $('<a>' + options.labelFinish + '</a>').attr("href", "#").addClass("btn btn-success buttonFinish")
    };
