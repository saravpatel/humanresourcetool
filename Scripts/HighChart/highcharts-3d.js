...
(function(d) {
    ...
    function u(c, b, a, f, e, g, d, j) {
        var k = [];
        g > e && g - e > p / 2 + 1.0E-4 ? (k = k.concat(u(c, b, a, f, e, e + p / 2, d, j)), k = k.concat(u(c, b, a, f, e + p / 2, g, d, j))) : g < e && e - g > p / 2 + 1.0E-4 ? (k = k.concat(u(c, b,
            a, f, e, e - p / 2, d, j)), k = k.concat(u(c, b, a, f, e - p / 2, g, d, j))) : (k = g - e, k = ["C", c + a * l(e) - a * E * k * q(e) + d, b + f * q(e) + f * E * k * l(e) + j, c + a * l(g) + a * E * k * q(g) + d, b + f * q(g) - f * E * k * l(g) + j, c + a * l(g) + d, b + f * q(g) + j]);
        return k
    }
        ...
        s = d.perspective = function(c, b, a) {
            ...
            return d.map(c, function(a) {
                ...
                var c = t * n * ((e ? a.y : a.x) - g) + p * ((e ? a.x : a.y) - i) + t * o * ((a.z || 0) - j),
                    f = k > 0 && k < Number.POSITIVE_INFINITY ?
                    k / (c + j + k) : 1;
    ...
    d.SVGRenderer.prototype.cuboid = function(c) {
        ...
        b.animate = function(a, b, c) {
            C(a.x) && C(a.y) ? (a = this.renderer.cuboidPath(a), this.front.attr({
                ...
                zIndex: -a[6]
            })) : a.opacity ? (this.front.animate(a, b, c), this.top.animate(a, b, c), this.side.animate(a, b, c)) : d.SVGElement.prototype.animate.call(this,
                a, b, c);
            return this
        };
        b.destroy = function() {
    ...
    d.SVGRenderer.prototype.arc3dPath = function(c) {
        ...
        d > z && e < z ? (h = h.concat(["L", a + n * l(w) + j, f + i * q(w) + v]), h = h.concat(u(a, f, n, i, w, z, j, v)), h = h.concat(["L", a + n * l(z), f + i * q(z)]), h = h.concat(u(a, f, n, i, z, d, 0, 0)), h = h.concat(["L", a + n * l(d) + j, f + i * q(d) + v]), h = h.concat(u(a,
            f, n, i, d, z, j, v)), h = h.concat(["L", a + n * l(z), f + i * q(z)]), h = h.concat(u(a, f, n, i, z, w, 0, 0))) : d > p - m && e < p - m && (h = h.concat(["L", a + n * l(w) + j, f + i * q(w) + v]), h = h.concat(u(a, f, n, i, w, d, j, v)), h = h.concat(["L", a + n * l(d), f + i * q(d)]), h = h.concat(u(a, f, n, i, d, w, 0, 0)));
        ...
        m = m.concat(["Z"]);
        t = ["M", a + n * t, f + i * o, "L", a + n * t + j, f + i *
            o + v, "L", a + x * t + j, f + y * o + v, "L", a + x * t, f + y * o, "Z"
        ];
    ...
    d.wrap(d.Chart.prototype, "init", function(c) {
        var b = [].slice.call(arguments, 1),
            a;
        if (b[0].chart && b[0].chart.options3d && b[0].chart.options3d.enabled) b[0].chart.options3d.alpha = (b[0].chart.options3d.alpha ||
            0) % 360, b[0].chart.options3d.beta = (b[0].chart.options3d.beta || 0) % 360, a = b[0].plotOptions || {}, a = a.pie || {}, a.borderColor = d.pick(a.borderColor, void 0);
        c.apply(this, b)
    });
    d.wrap(d.Chart.prototype, "setChartSize", function(c) {
        ...
        if (this.is3d()) {
            ...
            f[a ? "width" : "height"] = this.chartHeight +
                (d[0] || 0) + (d[2] || 0);
            this.scale3d = 1;
    ...
    d.wrap(d.Axis.prototype, "render", function(c) {
        ...
        if (this.chart.is3d()) {
            ...
            if (!this.isZAxis) this.horiz ? (i = {
                ...
                this.backFrame.animate(d) : this.backFrame = a.cuboid(d).attr({
                    fill: i.color,
                    zIndex: -3
                }).css({
                    stroke: i.color
    ...
    d.wrap(d.Axis.prototype, "getPlotBandPath",
        function(c) {
    ...
    d.wrap(d.Axis.prototype, "getTitlePosition", function(c) {
        ...
        if (b) a = s([this.swapZ({
            ...
            y: a.y,
            z: 0
        })], this.chart, !1)[0], a[this.horiz ? "y" : "x"] += (this.horiz ?
            1 : -1) * (this.opposite ? -1 : 1) * d, this.axisTitleMargin = d;
        return a
    });
    ...
    d.extend(G.prototype, {
        ...
        getSeriesExtremes: function() {
            ...
            c.dataMin = c.dataMax = c.ignoreMinPadding = c.ignoreMaxPadding =
                null;
            c.buildStacks && c.buildStacks();
            d.each(c.series, function(a) {
                if (a.visible || !b.options.chart.ignoreHiddenSeries)
                    if (c.hasVisibleSeries = !0, a = a.zData, a.length) c.dataMin = Math.min(A(c.dataMin, a[0]), Math.min.apply(null, a)), c.dataMax = Math.max(A(c.dataMax, a[0]), Math.max.apply(null, a))
            })
        }
    });
    ...
    if (d.VMLRenderer) d.setOptions({
        ...
        d.VMLRenderer.prototype.cuboid = d.SVGRenderer.prototype.cuboid, d.VMLRenderer.prototype.cuboidPath = d.SVGRenderer.prototype.cuboidPath, d.VMLRenderer.prototype.toLinePath = d.SVGRenderer.prototype.toLinePath, d.VMLRenderer.prototype.createElement3D = d.SVGRenderer.prototype.createElement3D, d.VMLRenderer.prototype.arc3d = function(c) {
            ...
            return c
        }, d.VMLRenderer.prototype.arc3dPath = d.SVGRenderer.prototype.arc3dPath, d.wrap(d.Axis.prototype, "render",
            function(c) {
                c.apply(this, [].slice.call(arguments, 1));
