...
{
    public class MeEmployeeProfileMethod
    {
        #region
        ...
        public MainResoureViewModel EmployeeProfileGetByID(int Id)
        {
            ...
            if (model.SSO.StartsWith("C"))
            {
                ...
                //{
                //    var details = _db.AspNetUsers.Where(x => x.Id == Employee.CustomerCareID).FirstOrDefault();
            ...
            model.ResourceType = Employee.ResourceType;
            ...
            model.NameTitle=(int)Employee.NameTitle;
           ...
           if(Employee.CustomerCareID!=null)
            {
                ...
                {
                    int customerId = Convert.ToInt32(values[i]);
                    var cname = _db.AspNetUsers.Where(x => x.Id == customerId && x.Archived == false).FirstOrDefault();
                    if(cname != null)
                    {
            ...
            {
                //if (Employee.BusinessID == item.Id)
                //{
            ...
            {
                model.Reportsto = EmployeeRelation.Reportsto;
                model.ReportToName = EmployeeRelation.Reportsto != null ? data.Where(x => x.Id == EmployeeRelation.Reportsto).FirstOrDefault().FirstName + " " + data.Where(x => x.Id == EmployeeRelation.Reportsto).FirstOrDefault().LastName + " - " + data.Where(x => x.Id == EmployeeRelation.Reportsto).FirstOrDefault().SSOID : string.Empty;
                model.AdditionalReportsto = Employee.AdditionalReportsto;                
                model.AdditionalReportToName = Employee.AdditionalReportsto != null && Employee.AdditionalReportsto!=0 ? data.Where(x => x.Id == Employee.AdditionalReportsto).FirstOrDefault().FirstName + " " + data.Where(x => x.Id == Employee.AdditionalReportsto).FirstOrDefault().LastName + " - " + data.Where(x => x.Id == Employee.AdditionalReportsto).FirstOrDefault().SSOID : string.Empty;
                model.HRResponsible = Employee.HRResponsible;
                model.HRResponsibleName = Employee.HRResponsible != null  && Employee.AdditionalReportsto!=0 ? data.Where(x => x.Id == Employee.HRResponsible).FirstOrDefault().FirstName + " " + data.Where(x => x.Id == Employee.HRResponsible).FirstOrDefault().LastName + " - " + data.Where(x => x.Id == Employee.HRResponsible).FirstOrDefault().SSOID : string.Empty;
                model.BusinessID = EmployeeRelation.BusinessID;
                ...
                {
                    //if (Employee.DivisionID == item.Id)
                    //{
                ...
                model.DivisionID = EmployeeRelation.DivisionID;
                model.PoolID = EmployeeRelation.PoolID;
                model.FunctionID = EmployeeRelation.FunctionID;
                ...
                {
                    //if (Employee.FunctionID == item.Id)
                    //{
        ...
        public void SaveProfileSet(MainResoureViewModel model)
        {
            ...
            if (AddUser.SSOID.Contains('C'))
            {
                ...
                // AddUser.CustomerCareID = userData.Id;

                //Address Info

                if (AddressInfo != null)
                {
                    AddressInfo.ContactAddress = model.Address;
                    AddressInfo.PostCode = model.PostalCode;
                }
                            }
