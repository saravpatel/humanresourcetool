...
$("#tableDivResource").on('click', '#SaveProfileRecord', function () {
    ...
    var reportToId = $("#page_content").find("#selectID").val();
    var addRepoTo = $("#page_content").find("#AddRespID").val();
    var hrId = $("#page_content").find("#HRResID").val();
    ...
    if (iserror) {
        ...
        var model = {
            ...
            Reportsto: reportToId,
            AdditionalReportsto: addRepoTo,
            HRResponsible: hrId,
...
$("#tableDivResource").on('click', '#btn-Edit-SalaryDeduction', function () {
    ...
    $(".hrtoolLoader").show();
    //$('#addsalaryDeduction').toggle('show');
    //$('#addsalaryDeduction').modal('show');
    var hiddenId = $("#tableDivSalary").find("#hiddenId").val();
    ...
    $.ajax({
        ...
        success: function (data) {
            //$('#addsalaryDeduction').toggle('show');
            $('#addsalaryDeduction').modal('show');
            $('#addsalaryDeduction').removeClass('Out').addClass('in');
            $('#addsalaryDeduction').css('display',"Block");
            $("#tableDivDeductionSalary").find('#AddsalaryDeductionDeductionBody').html('');
            $("#tableDivDeductionSalary").find('#AddsalaryDeductionDeductionBody').html(data);
