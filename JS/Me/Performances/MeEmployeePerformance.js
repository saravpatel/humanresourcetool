...
$("#ActiveReviewHTML").on("click", ".btn-startnewreview", function () {
    ...
    $.ajax({
        url: MeconstantEmpPerformance.CheckIsPerformanceReviewExist,
        data: { EmployeeId: EmpId },
        success: function (data) {
            //if(data.IsEmployeeExistReview==0)
            $.ajax({
                url: MeconstantEmpPerformance.StartNewReview,
                data: { EmployeeId: EmpId },
                success: function (data) {
...
$("#btn-saveReview").on('click', function () {
    ...
    if (!isError) {
        $.ajax({
            ...
            url: MeconstantEmpPerformance.SaveNewReview,
...
function getQuestionData(QueId, IsActivePastFlag, Flag, IsManager) {
    ...
    $.ajax({
        url: MeconstantEmpPerformance.getQuestionDataByID,
...
function ShareEmployeePerformance() {
    ...
    $.ajax({
        url: MeconstantEmpPerformance.sendMailtoshareperformnce,
        data: {
...
function UnShareEmployeePerformance() {
    ...
    var EmployeeId = $("#Employeeid").val();
    $.ajax({
        url: MeconstantEmpPerformance.sendMailtoUnshareperformnce,
        data: {
            ManagerId: ManagerId, EmployeeId: EmployeeId
        },
        success: function (data) {
...
function sendEmailtoCoworker(IsActivePastFlag) {

    var EmpID = $("#Hiddemn_EmployeeId").val();
    var Ids = $('#selectID').val();
    var ReviewId = $("#hdnReview").val();
    Username = $('#txtnameUsername').val();
    Email = $('#txtEmail').val();
    $.ajax({
        url: constantvar.SendEmailToInvitees,
        data: { InviteesIDs: Ids, EmpID: EmpID, ReviewId: ReviewId, Username: Username, Email: Email },
        success: function (response) {
            ...
            if (response.success) {
                if (response.message == "") {
                    ...
                    $('#AddCoworker').hide();
                    $('.modal-backdrop').hide();
                    GetDetailofCoworker(ReviewId, 1, EmpID, IsActivePastFlag);                    
                }
                else {
...
function sendEmailtoCustomer(IsActivePastFlag) {
    ...
    Email = $('#txtEmail').val();
    $.ajax({
        url: constantvar.SendEmailToInviteesCustomer,
        data: { InviteesIDs: Ids, EmpID: EmpID, ReviewId: ReviewId, Username: Username, Email: Email },
        success: function (response) {
            ...
            if (response.success) {
                if (response.message == "") {
                    ...
                    $(".toast-info-invitation-decline").show();
                    setTimeout(function () { $(".toast-info-invitation-decline").hide(); }, 2500);
                }
...
$("#submitCustomerDetails").on('click', function () {
    ...
    var questionListJSV = JSON.stringify(questionList);
    $.ajax({
        url: constantInviteCoPerformance.UpdateCustomerCoreScore,
        data: { PerCoId: PerfCoWorkerId, questionListJSV: questionListJSV },
        success: function (data) {
...
function openReviewSegments(empPerReviewId, ReviewId, EmpID, IsActivePastFlag) {
    $.ajax({
        url: MeconstantEmpPerformance.getReviewDetails,
...
function GetEmployeeSegmentsDetails(Id, QueationType, Flag, IsJobRoleCustomer, IsManagerEmployee, IsActivePastFlag, IsManager) {
    ...
    $.ajax({
        url: MeconstantEmpPerformance.GetEmployeeSegmentsDetailsById,
...
function getEmployeeDetails(ReviewId, IsManagerEmployee, IsActivePastFlag, IsManager) {
    ...
    var EmpId = $("#Hiddemn_EmployeeId").val();
    $.ajax({
        url: MeconstantEmpPerformance.GetEmployeeSegmentData,
...
function saveEmployeePerformanceDetails(Flag, IsActivePastFlag) {
    ...
    $.ajax({
        url: MeconstantEmpPerformance.saveEmployeePerformanceDetails,
...
function EmployeeObjectiveOfPerformance() {
    ...
    $.ajax({
        ...
        url: MeconstantEmpPerformance.EmployeeObjectiveOfPerformance,
        success: function (data) {
...
function SaveGoalEmployeePerReview(ReviewId, ManagerId, IsActivePastFlag) {
    ...
    if (!isError) {
        $.ajax({
            type: "POST",
            data: JSON.stringify(model),
            url: MeconstantEmpPerformance.saveEmployeePerformanceGoal,
            contentType: "application/json",
            success: function (data) {
...
function GetProgressData(Id, EmployeeId, EmpPerformanceId) {
    $.ajax({
        ...
        url: MeconstantEmpPerformance.ViewPerformanceObjectiveProgress,
        success: function (data) {
...
function SaveGoalEmployeePerProgressDocument(ReviewId, ManagerId, IsActivePastFlag) {
    ...
    $.ajax({
        ...
        url: MeconstantEmpPerformance.SavePerfromanceGoalDocument,
        success: function (data) {
...
function getGoalComment(CmtId, GoalId, EmpPerformanceId, EmployeeId) {
    $.ajax({
        ...
        url: MeconstantEmpPerformance.GetGoalComment,
        success: function (data) {
            $("#GoalPerformnceProgressModal").modal('hide');
...
function SaveGoalComment(ReviewId, ManagerId, IsActivePastFlag) {
    ...
    $.ajax({
        ...
        url: MeconstantEmpPerformance.SaveGoalComment,
        success: function (data) {
...
function FilterByGoalStatus(EmployeeId) {
    ...
    $.ajax({
        ...
        url: MeconstantEmpPerformance.FilterByGoalStatus,
        success: function (data) {
            $("#CoDetailsView").find("#CoworkerDetails").html('');
            $("#CoDetailsView").find("#CoworkerDetails").html(data);
            GoalChartData();
