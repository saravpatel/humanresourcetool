...
var bol = false;
$(".accordion_container").find(".accordion_row").on('click', function () {
    var ht = $(".page-content-wrapper").height();
    $("#page_content").css("min-height", "" + $(".page-content-wrapper").height() + "px");
})
...
function getWorkPattData() {
    ...
    var date = $(".accordion_container").find("#EmployeeProjectPlanner_TimeSheetModel").find("#EmployeeProjectPlanner_TimeSheetBody").find("#txt_Date").val();
...
$(".accordion_container").on("click", ".btn_AddEdit_TimeSheet", function () {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $('.accordion_container').find('#btn_AddNew_TimesheetDetail').click();
...
$(".accordion_container").on("click", "#btn_AddNew_TimesheetDetail", function () {
    $.ajax({
        ...
        success: function (data) {
            ...
            spinner();
            $(".accordion_container").find('.Timesheet_Detail_Div:first').find('.timesheet_delete_icon').parent().hide();
        }
    });
});

$(".accordion_container").on("click", ".timesheet_delete_icon", function () {
    if ($(".accordion_container").find(".timesheet_delete_icon").length > 1) {
        $(this).parent().parent().parent().parent().remove();
    }
});
$("#EmployeeProjectPlanner_TravelLeaveModel").on('click', '.file-deleteicon', function () {
    $(this).parent().remove();
});
            ...
            $(".accordion_container").find("#EmployeeProjectPlanner_TravelLeaveModel").find("#EmployeeProjectPlanner_TravelLeaveBody").find("#txt_StartDate").Zebra_DatePicker({
                ...
                onSelect: function () {
                   // calculateAnnualDateDiffTravelLeave();
                    $(".accordion_container").find("#EmployeeProjectPlanner_TravelLeaveModel").find("#EmployeeProjectPlanner_TravelLeaveBody").find("#lbl-error-EndDate").hide();
                    $(".accordion_container").find("#EmployeeProjectPlanner_TravelLeaveModel").find("#EmployeeProjectPlanner_TravelLeaveBody").find("#lbl-error-GreaterEndDate").hide();
...
//        diffDays = diffDays + 1;
//        $(".accordion_container").find("#EmployeeProjectPlanner_TravelLeaveModel").find("#EmployeeProjectPlanner_TravelLeaveBody").find("#txt_Duration").val(days);
...
function TravelLeaveonFinishCallback(obj, context) {
    ...
    if (selectedRadio == "adayormore") {
        ...
        var reasonForLeave = $(".accordion_container").find("#EmployeeProjectPlanner_TravelLeaveModel").find("#EmployeeProjectPlanner_TravelLeaveBody").find("#drp-ReasonForTravelId").val();
        var startDate = $(".accordion_container").find("#EmployeeProjectPlanner_TravelLeaveModel").find("#EmployeeProjectPlanner_TravelLeaveBody").find("#txt_LessThenStartDate").val().trim();
        var hourSD = $(".accordion_container").find("#EmployeeProjectPlanner_TravelLeaveModel").find("#EmployeeProjectPlanner_TravelLeaveBody").find("#drp-HourseListSD").val();
        var minSD = $(".accordion_container").find("#EmployeeProjectPlanner_TravelLeaveModel").find("#EmployeeProjectPlanner_TravelLeaveBody").find("#drp-MinutesListSD").val();
        var hourED = $(".accordion_container").find("#EmployeeProjectPlanner_TravelLeaveModel").find("#EmployeeProjectPlanner_TravelLeaveBody").find("#drp-HourseListED").val();
        var minED = $(".accordion_container").find("#EmployeeProjectPlanner_TravelLeaveModel").find("#EmployeeProjectPlanner_TravelLeaveBody").find("#drp-MinutesListED").val();
...
$("#page_content").on("click", ".btn-PlannerProjectSettings", function () {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $("#page_content").find("#EmployeeProjectPlanner_Settings").find("#EmployeeProjectPlanner_SettingsBody").html('');
            $("#page_content").find("#EmployeeProjectPlanner_Settings").find("#EmployeeProjectPlanner_SettingsBody").html(data);
...
$("#page_content").on("click", ".btn-Project-closeModel", function () {
    ...
    var model = {
        ...
        AuthoriseUserId: $("#page_content").find("#selectauthID").val(),
...
$("#drp-publicHolidayCountry").change(function () {
    var value = $(this).val();
    if (value != "0") {
        $('#EmployeeProjectPlanner_Effactive_PublicholidayModal').modal('show');
        $.ajax({
            url: constantProjectPlanner.BindPublicHolidayTemplate,
            data: { CountryId: value },
            success: function (data) {
                $('#EmployeeProjectPlanner_Effactive_PublicholidayModal').find("#Effactive_PublicholidayModal").html("");
                $('#EmployeeProjectPlanner_Effactive_PublicholidayModal').find("#Effactive_PublicholidayModal").html(data);
                $('#EmployeeProjectPlanner_Effactive_PublicholidayModal').find("#Effactive_PublicholidayModal").find("#txt_EffectiveDate").Zebra_DatePicker({
                    direction: false,
                    showButtonPanel: false,
                    format: 'd-m-Y',
                    onSelect: function () {
                        $('#EmployeeProjectPlanner_Effactive_PublicholidayModal').find("#Effactive_PublicholidayModal").find("#lbl-error-EffectiveDate").hide();
                    }
                });
...
$("#btn-submit-EmployeeProjectPlanner-EffactiveDateSave").click(function () {

    $(".hrtoolLoader").show();
    $(".modal-backdrop").show();
    var effactiveDate = $('#EmployeeProjectPlanner_Effactive_PublicholidayModal').find("#Effactive_PublicholidayModal").find("#txt_EffectiveDate").val().trim();
    var isError = false;
    if (effactiveDate == "") {
        isError = true;
        $('#EmployeeProjectPlanner_Effactive_PublicholidayModal').find("#Effactive_PublicholidayModal").find("#lbl-error-EffectiveDate").show();
    }
    var countryId = $('#EmployeeProjectPlanner_Effactive_PublicholidayModal').find("#Effactive_PublicholidayModal").find("#countryId").val();
...
function calculateDateDiff(stratDate, endDate) {
    if (stratDate != "" || endDate != "") {
        if (StartDateValidation(stratDate, endDate)) {
            ...
            $("#txt_Duration").val('');
            $(".accordion_container").find("#EmployeeProjectPlanner_TravelLeaveModel").find("#EmployeeProjectPlanner_TravelLeaveBody").find("#lbl-error-GreaterEndDate").show();
            $(".accordion_container").find("#EmployeeProjectPlanner_TravelLeaveModel").find("#EmployeeProjectPlanner_TravelLeaveBody").find("#txt_EndDate").val('');
        }
        else {
...
$(".accordion_container").on("click", ".btn_AddEdit_Scheduling", function () {
    ...
    $.ajax({
        url: constantProjectPlanner.addEdit_ResourceScheduling,
        data: { Id: id, Date: dayId, Month: monthId, Year: yearId, EmpId: empId },
        success: function (data) {
...
function calculateDateDiff(stratDate, endDate) {
    if (stratDate != "" || endDate != "") {
        if (StartDateValidation(stratDate, endDate)) {
            $("#page_content").find("#lbl-error-GreaterEndDate").show();
            $("#page_content").find("#txt_EndDate").val('');
            $("#page_content").find("#txt_DurationDays").val('');
...
$("#page_content").on('change', "#drp-project", function () {
    var EmpId= $("#currentEmployeeId").val();
    var ProId = $("#drp-project").val();
    var holidayCountry = $("#holidayCountryId").val();
    var SYear = $("#serYear").val();
    var monthId = $("#monthId").val();
    $.ajax({
        url: constantProjectPlanner.searchByProject,
        data: { YearId: SYear, EmployeeId: EmpId, HolidayCountryId: holidayCountry, projectId: ProId },
        success: function (data) {
            $(".changemonth_next").attr("data-yearid", SYear);
            $(".changemonth_previous").attr("data-yearid", SYear);
            var newString = "January " + SYear + " - December " + SYear;
            $(".yearsName").html("");
            $(".yearsName").html(newString);
            $(".accordion_container").html("");
            $(".accordion_container").html(data);
...
$("#page_content").on('change', "#drpYear", function () {
    var EmpId = $("#currentEmployeeId").val();
    var holidayCountry = $("#holidayCountryId").val();
    var SYear = $("#drpYear").val();
    var monthId = $("#monthId").val();
    $.ajax({
        url: constantProjectPlanner.searchByYear,
        data: { YearId: SYear, EmployeeId: EmpId, HolidayCountryId: holidayCountry },
        success: function (data) {
            $(".changemonth_next").attr("data-yearid", SYear);
            $(".changemonth_previous").attr("data-yearid", SYear);
            var newString = "January " + SYear + " - December " + SYear;
